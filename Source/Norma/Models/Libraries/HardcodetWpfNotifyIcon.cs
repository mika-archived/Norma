...
{
    internal class HardcodetWpfNotifyIcon : Library
    {
        #region Overrides of Library

        public override string Name => "Hardcodet WPF NotifyIcon";
        public override string Url => "http://www.hardcodet.net/projects/wpf-notifyicon";
